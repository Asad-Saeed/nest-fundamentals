...
// import { UsersController } from './users/constrollers/users.controller';
...
// 1. Root Module (imports other modules)
// 2. Feature Module
// 3. Shared Module
// 4. Global Module (don't need to import this module in other modules)
@Module({
  imports: [UsersModule],
})
export class AppModule {}
